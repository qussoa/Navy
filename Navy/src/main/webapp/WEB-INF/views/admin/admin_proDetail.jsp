...
<section>
	...
	<button type="button" class="btn_pro_update" data-id="${productVO.p_code}">수정</button>
	<button type="button" class="btn_pro_delete" data-id="${productVO.p_code}">삭제</button>
	<button type="button" class="btn_pro_list">목록</button>
